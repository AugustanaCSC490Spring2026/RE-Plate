    ...
    return Scaffold(
      ...
      drawer: Drawer(
        ...
        child: ListView(
          ...
          children: [
            ...
            ListTile(
              leading: const Icon(Icons.home_outlined, color:  Color.fromARGB(255, 101, 76, 143)),
              title: Text(
                'Home',
                style: GoogleFonts.raleway(
            ...
            ListTile(
              leading: const Icon(Icons.history_outlined, color:  Color.fromARGB(255, 111, 42, 175)),
              title: Text(
                'History',
                style: GoogleFonts.raleway(
                  textStyle: const TextStyle(fontWeight: FontWeight.w600),
            ...
            ListTile(
              leading: const Icon(Icons.person_outline, color:  Color.fromARGB(255, 111, 40, 197)),
              title: Text(
                'My Profile',
                style: GoogleFonts.raleway(
                  textStyle: const TextStyle(fontWeight: FontWeight.w600),
      ...
      appBar: AppBar(
        title: Row(
          ...
          children: [
          Image.asset('lib/assets/images/replateLogo1.png', height: 36, fit: BoxFit.contain,),
